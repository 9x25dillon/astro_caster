...
| 1.2 | **Real personal birth data in a public repo.** `lat=34.935, lng=-117.199` + `1987-11-11 10:23` in 4 test files labeled "the user's chart", and `34.9333,-117.1833` as the frontend default chart. | 5 files (§3) | **High** (PII exposure) |
